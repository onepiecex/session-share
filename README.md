...
```
<dependency>
    <groupId>com.github.onepiecex.session.spring.boot.starter</groupId>
    <artifactId>session-spring-boot-starter</artifactId>
    <version>1.0</version>
</dependency>
```
配置(application.yaml)
...
```
<dependency>
  <groupId>com.github.onepiecex.session.core</groupId>
