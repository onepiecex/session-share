...
import com.github.session.share.core.util.CookieDataCodec;
import com.github.session.share.core.util.CookieEncryption;
import com.github.session.share.core.util.Crypto;
...
public class SessionImpl implements Session {
    ...
    public void setAttribute(String name, Object value) {
        ...
        if (value == null) {
            ...
            data.put(name, JSONObject.toJSONString(value));
        }
    }
    ...
    public <T> T getAttribute(String name, Class<T> cls) {
        ...
        return JSONObject.parseObject(val, cls);
    }
